...
const EmailSentScreen: React.FC<EmailSentScreenProps> = ({ navigation }) => {
  return (
    <ScreenContainer>
      <Spacer height={110} />
      ...
      <LogoWithSpacer imageSource={require('@assets/images/png/emai_sent_img.png')} height={53} />
      <Spacer height={38} />
      <CustomButton title='Llévame allá' onPress={() => { console.log('Pipipip') }} fontWeight='500' textSize={14} />
      <Spacer height={12} />
